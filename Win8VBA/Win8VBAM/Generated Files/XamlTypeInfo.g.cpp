...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"Win8Snes9x.CheatPane")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.UserControl"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::Win8Snes9x::CheatPane(); 
            };
    ...
    if (typeName == L"Win8Snes9x.CheatData")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Object"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::Win8Snes9x::CheatData(); 
            };
        userType->AddMemberName(L"Enabled");
        userType->AddMemberName(L"Description");
        userType->AddMemberName(L"CheatCode");
...
{
    if (longMemberName == L"Win8Snes9x.CheatPane.Cancelled")
    {
        ...
        xamlMember->Getter =
            ...
            {
                auto that = (::Win8Snes9x::CheatPane^)instance;
    ...
    if (longMemberName == L"Win8Snes9x.CheatData.Enabled")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Enabled", L"Boolean");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::Win8Snes9x::CheatData^)instance;
                auto value = ref new ::Platform::Box<::Platform::Boolean>(that->Enabled);
                return value;
            };
        ...
        xamlMember->Setter =
            [](Object^ instance, Object^ value) -> void
            {
                auto that = (::Win8Snes9x::CheatData^)instance;
                auto boxedValue = (::Platform::IBox<::Platform::Boolean>^)value;
                that->Enabled = boxedValue->Value;
            };
        return xamlMember;
    }

    if (longMemberName == L"Win8Snes9x.CheatData.Description")
    {
    ...
    if (longMemberName == L"Win8Snes9x.CheatData.CheatCode")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"CheatCode", L"String");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::Win8Snes9x::CheatData^)instance;
                return that->CheatCode;
            };
        ...
        xamlMember->Setter =
            ...
            {
                auto that = (::Win8Snes9x::CheatData^)instance;
                that->CheatCode = (::Platform::String^)value;
            };
        return xamlMember;
    }
