...
#ifdef GBC
	this->lKeyBox->Visibility = Windows::UI::Xaml::Visibility::Collapsed;
	this->lKeyLabel->Visibility = Windows::UI::Xaml::Visibility::Collapsed;

	this->rKeyBox->Visibility = Windows::UI::Xaml::Visibility::Collapsed;
	this->rKeyLabel->Visibility = Windows::UI::Xaml::Visibility::Collapsed;
#endif
}
